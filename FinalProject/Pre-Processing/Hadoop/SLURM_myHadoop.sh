...
#SBATCH --mail-user=anantsar@buffalo.edu
#SBATCH --output=Result_word_count.out
...
$HADOOP_HOME/bin/hadoop --config $HADOOP_CONF_DIR dfs -put input input
#$HADOOP_HOME/bin/hadoop --config $HADOOP_CONF_DIR dfs -put amy.txt amy.txt
...
$HADOOP_HOME/bin/hadoop --config $HADOOP_CONF_DIR jar PreProcessing.jar WordCount input output_wordcount
